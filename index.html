...
<head>
    ...
    <script>
        ...
        function startSlideShow() {
            $('#slideshow').children().eq(count).css("display", "inline");
            console.log($('#slideshow').length);
            setInterval(function () {
                console.log("c: " + count);
                if (count < $('#slideshow').length) {
                    console.log("haldkjfalskdjf");
                    $('#slideshow').children().eq(count).fadeOut(1000, "linear", null);
                    $('#slideshow').children().eq(count).css("display", "none");
                    ++count;
                    $('#slideshow').children().eq(count).css("display", "inline");
                } else {
                    console.log("wtf");
...
<body>
    ...
    <div id="slideshow">
        <div class="slide">
            <article id="article">
                "We Are A Small Company, We Are Yoy. Our Staff of 6 Are Aiming To Create
                Interactive And Complex Websites Using Javascript, PHP, Jquery, And The
                Latest CSS3."
            </article>
        </div>
        <div class="slide">
